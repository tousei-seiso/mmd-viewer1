...
//  2013/05/01
//  LocalShadowで使用出来るように改変 by 針金P
//
////////////////////////////////////////////////////////////////////////////////////////////////
// パラメータ宣言

////////////////// LocalShadowでこれを追加します //////////////////////
// ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓

// LocalShadowの必要なパラメータを取り込む
...
float3   LightDirection[MMM_LightCount]    : LIGHTDIRECTIONS;   // ライト方向
...
struct VS_OUTPUT {
    ...
    //////////////////// LocalShadowに対応するにはこれを追加します //////////////////////
    // ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓
    float4 ZCalcTex : TEXCOORD7;    // LocalShadow用Z値
    // ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
    /////////////////////////////////////////////////////////////////////////////////////
...
VS_OUTPUT Basic_VS(MMM_SKINNING_INPUT IN, uniform bool useTexture, uniform bool useSphereMap, uniform bool useToon, uniform bool useSelfShadow)
{
    ...
    // Localライト視点によるワールドビュー射影変換
    Out.ZCalcTex = mul( SkinOut.Position, LocalShadow_LightWorldViewProjMatrix );
    ...
    if (useSelfShadow) {
        ...
        if(LocalShadow_Valid && LightEnables[0]){
            ...
            if( !any( saturate(TransTexCoord) - TransTexCoord ) ) {
                comp = LocalShadow_GetSelfShadowRate(TransTexCoord, IN.ZCalcTex.z);
            }
            ...
            // 影色に濃度を加味する
            LocalShadow_COLOR Out = LocalShadow_GetShadowDensity(Color, ShadowColor, useToon, LightNormal);
